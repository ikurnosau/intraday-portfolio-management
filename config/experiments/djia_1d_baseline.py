...
from data.processed.targets import Balanced3ClassClassification, Balanced5ClassClassification, BinaryClassification, MeanReturnSignClassification, FutureMeanReturnClassification, FutureHorizonReturnClassification
...
data_config = DataConfig(
    ...
    target=FutureHorizonReturnClassification(base_feature='close', horizon=20, class_values=[0.0, 0.25, 0.5, 0.75, 1.0]),
    normalizer=MinMaxNormalizerOverWindow(window=60, fit_feature=None),
    missing_values_handler=DummyMissingValuesHandler(),
    train_set_last_date=datetime(2007, 9, 1, tzinfo=timezone.utc), 
    in_seq_len=60,
